...
public class BullsAndCows extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event){
        ...
        //check which button the axtion performed is from
        else {
    ...
    public void createAppForm(){
        ...
        //add a text area with a cuan border around it and scrollbars
    ...
    private void runGuess(String numString){
        ...
        //male sure guess is valid
        if ((guess / 1000) <= 0 || (guess / 1000) >= 10){
            JOptionPane.showMessageDialog(null,"Please enter in a four-digit number without repaete or 0.");
            numOfGuesses--;
        }
        ...
        //calculate number of bulls and cows
            ...
            textArea.append("      " + numOfGuesses + "      |      Your guess: " +
            guess + "      |      Bulls: " + bulls + "      Cows: " + cows + NEWLINE);
        }
